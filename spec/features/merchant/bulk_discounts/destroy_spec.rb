...
describe 'As a merchant user deleting an existing bulk discount' do
  before :each do
  ...
  it "I can delete an existing bulk discount" do
    ...
    expect(page).to_not have_content(@bulk_discount_1.description)
    expect(page).to_not have_content(@bulk_discount_1.discount_percent)
    expect(page).to_not have_content(@bulk_discount_1.minimum_quantity)
  end
end
